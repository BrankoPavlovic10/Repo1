	...
	<body>
		...
		<div class="page">
			<div class="column">
				...
				<div class="content" id="vesti">
					<div class="petition">
						<h1>Najvažnije vesti:</h1>
						...
						include_once 'php/vezaSaBazom.php';
						 ...
						 if($provera > 0){
							...
							while($row=mysqli_fetch_assoc($rezultat) ){
								...
								echo "<p style='font-size:20px;text-align:center;font-weight:bold;color:white   '>" . $row['naslov'] . "</p>";
								echo "<p style='font-size:20px;text-align:center;color:white'>" . $row['sadrzaj'] . "</p>";
